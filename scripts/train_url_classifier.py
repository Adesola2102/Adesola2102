"""
Trains the Random Forest URL phishing classifier on data/raw/url_dataset.csv
...
from phishguard.data.url_features import (  # noqa: E402
    FEATURE_NAMES,
    extract_url_features,
)
from phishguard.models.classifier import PhishingClassifier  # noqa: E402

DATA_PATH = ROOT / "data" / "raw" / "url_dataset.csv"
...
def main() -> None:
    ...
    print(f"Loaded {len(df)} labelled URLs from {DATA_PATH}")
    ...
    clf = PhishingClassifier(feature_names=FEATURE_NAMES, name="url_classifier")
