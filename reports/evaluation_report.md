...
- Flesch Reading Ease — raw SHAP text: **8.7** vs translated sentence: **36.0** (higher is easier to read)
- Flesch-Kincaid Grade Level — raw SHAP text: **12.6** vs translated sentence: **16.2** (lower is easier to read)
- Average length — raw SHAP text: **14.0 words** vs translated sentence: **31.9 words**

## Email classifier sample (n=30)

- Sample accuracy on this evaluation batch: **93.3%**
- Flesch Reading Ease — raw SHAP text: **-51.3** vs translated sentence: **24.0** (higher is easier to read)
- Flesch-Kincaid Grade Level — raw SHAP text: **21.0** vs translated sentence: **17.6** (lower is easier to read)
- Average length — raw SHAP text: **14.0 words** vs translated sentence: **31.1 words**
...
**Plain-language translation:** This email looks LEGITIMATE with 96% confidence: it does not rely on capital letters for emphasis, addresses the recipient normally rather than with a generic greeting, and does not use urgent or pressuring language.
...
**Plain-language translation:** This email looks LEGITIMATE with 97% confidence: it does not rely on capital letters for emphasis, addresses the recipient normally rather than with a generic greeting, and contains few or no embedded links.
...
**Plain-language translation:** This email looks LEGITIMATE with 99% confidence: it does not rely on capital letters for emphasis, addresses the recipient normally rather than with a generic greeting, and does not use urgent or pressuring language.
